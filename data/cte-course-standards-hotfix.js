...
(function () {
  ...
  function apply(categoryId, groupId, courseId, prefix, texts) {
    ...
    if (!course) return;
    course.standards = texts.map((text, index) => ({ code: `${prefix}.${index + 1}`, text }));
  }
  ...
  apply("industrial-maintenance-technology", "welding-maintenance-technician", "480528", "SMAWGB", [
    "Practice and perform safe shop procedures at all times.", "Apply the technical math required for employment opportunities in welding.", "Perform all duties with emphasis on integrity, responsibility, quality, discipline and teamwork.", "Weld SMAW groove welds in all positions."
  ]);
  ...
  apply("transportation", "diesel-immr", "470442", "DCOOP", [
    "Gain career awareness and the opportunity to test career choices.", "Receive work experience related to career interests prior to graduation.", "Integrate classroom studies with work experience.", "Receive exposure to facilities and equipment unavailable in a classroom setting.", "Increase employability potential after graduation.", "Earn funds to help finance education expenses."
  ]);

  apply("transportation", "diesel-immr", "470445", "DINT", [
    "Gain career awareness and the opportunity to test career choices.", "Receive work experience related to career interests prior to graduation.", "Integrate classroom studies with work experience.", "Receive exposure to facilities and equipment unavailable in a classroom setting.", "Increase employability potential after graduation."
  ]);
})();
